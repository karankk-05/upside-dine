...
MIDDLEWARE = [
    ...
    # "apps.users.middleware.RateLimitMiddleware", # Removed rate limiter explicitly for testing
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=36500), # Extended to infinity (100 years)
